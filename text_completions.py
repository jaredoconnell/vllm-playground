...
from vllm.engine.async_llm_engine import AsyncLLMEngine, AsyngEngineArgs, PromptType, SamplingParams, RequestOutput
import time
import os
...
engine_args = AsyncEngineArgs(model=model, hf_token=hf_token, device="cuda")
...
) -> AsyncGenerator[None]: # AsyncGenerator[Union[StreamingTextResponse, ResponseSummary], None]:
...
handle_llm_output(llm_generator, start_time, request_id)
